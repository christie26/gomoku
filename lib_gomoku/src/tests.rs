...
mod add_stone_add_pattern {
        ...
        run_cases(
            ...
            vec![
                ...
                Case { row: 5, base: 5, pattern: "..XX.O", index: 3,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9)]] },
                Case { row: 5, base: 5, pattern: "..XX.O", index: 5,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9)]] },
                // O.X.X.O
                Case { row: 5, base: 5, pattern: "O.X.X.O", index: 0,
    ...
    fn open_three() {
        run_cases(
            ...
            vec![
                // XXX..
                Case { row: 5, base: 4, pattern: "OXXX..", index: 0,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9)]] },
                ...
                Case { row: 5, base: 4, pattern: "OXXX..", index: 3,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9)]] },
                // XX.X.
                Case { row: 1, base: 5, pattern: "OXX.X.O", index: 0,
                ...
                Case { row: 1, base: 5, pattern: "OXX.X.O", index: 4,
                       before: vec![], after: vec![vec![(1, 6), (1, 7), (1, 8), (1, 9), (1, 10)]] },
                Case { row: 1, base: 5, pattern: "OXX.X.O", index: 6,
                       before: vec![], after: vec![vec![(1, 6), (1, 7), (1, 8), (1, 9), (1, 10)]] },
                // X.XX.
                Case { row: 1, base: 5, pattern: "OX.XX.O", index: 0,
                       before: vec![], after: vec![vec![(1, 6), (1, 7), (1, 8), (1, 9), (1, 10)]] },
                ...
                Case { row: 1, base: 5, pattern: "OX.XX.O", index: 4,
                       before: vec![], after: vec![vec![(1, 6), (1, 7), (1, 8), (1, 9), (1, 10)]] },
                Case { row: 1, base: 5, pattern: "OX.XX.O", index: 6,
                       before: vec![], after: vec![vec![(1, 6), (1, 7), (1, 8), (1, 9), (1, 10)]] },
                // .XXX.
                Case { row: 1, base: 5, pattern: "O.XXX.O", index: 0,
                       before: vec![], after: vec![vec![(1, 6), (1, 7), (1, 8), (1, 9), (1, 10)]] },
                ...
                Case { row: 1, base: 5, pattern: "O.XXX.O", index: 4,
                       before: vec![], after: vec![vec![(1, 6), (1, 7), (1, 8), (1, 9), (1, 10)]] },
                // X..XX
                Case { row: 1, base: 5, pattern: "OX..XXO", index: 0,
                       before: vec![], after: vec![vec![(1, 6), (1, 7), (1, 8), (1, 9), (1, 10)]] },
                ...
                Case { row: 1, base: 5, pattern: "OX..XXO", index: 5,
                       before: vec![], after: vec![vec![(1, 6), (1, 7), (1, 8), (1, 9), (1, 10)]] },
                Case { row: 1, base: 5, pattern: "OX..XXO", index: 6,
                       before: vec![], after: vec![vec![(1, 6), (1, 7), (1, 8), (1, 9), (1, 10)]] },
                // X.X.X
                Case { row: 1, base: 5, pattern: "OX.X.XO", index: 0,
                       before: vec![], after: vec![vec![(1, 6), (1, 7), (1, 8), (1, 9), (1, 10)]] },
        ...
        run_cases(
            ...
            vec![
                ...
                Case { row: 5, base: 5, pattern: "..XXX..", index: 3,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9), (5, 10), (5, 11)]] },
                // .XXX..
                Case { row: 5, base: 5, pattern: "O.XXX..O", index: 0,
                ...
                Case { row: 5, base: 5, pattern: "O.XXX..O", index: 4,
                       before: vec![], after: vec![vec![(5, 6), (5, 7), (5, 8), (5, 9), (5, 10), (5, 11)]] },
                Case { row: 5, base: 5, pattern: "O.XXX..O", index: 7,
                       before: vec![], after: vec![vec![(5, 6), (5, 7), (5, 8), (5, 9), (5, 10), (5, 11)]] },
                // .XX.X.
                Case { row: 5, base: 5, pattern: "O.XX.X.O", index: 0,
                       before: vec![], after: vec![vec![(5, 6), (5, 7), (5, 8), (5, 9), (5, 10), (5, 11)]] },
                ...
                Case { row: 5, base: 5, pattern: "O.XX.X.O", index: 5,
                       before: vec![], after: vec![vec![(5, 6), (5, 7), (5, 8), (5, 9), (5, 10), (5, 11)]] },
                Case { row: 5, base: 5, pattern: "O.XX.X.O", index: 7,
                       before: vec![], after: vec![vec![(5, 6), (5, 7), (5, 8), (5, 9), (5, 10), (5, 11)]] },
            ],
        );
    }
    ...
    fn block_four() {
        run_cases(
            ...
            vec![
                // O.XXXXO -> .XXXXO
                Case { row: 5, base: 4, pattern: "O.XXXXO", index: 0,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9), (5, 10)]] },
                ...
                Case { row: 5, base: 4, pattern: "O.XXXXO", index: 5,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9), (5, 10)]] },
                Case { row: 5, base: 4, pattern: "O.XXXXO", index: 6,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9), (5, 10)]] },
                // OX.XXXO -> X.XXX
                Case { row: 5, base: 4, pattern: "OX.XXXO", index: 0,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9)]] },
                ...
                Case { row: 5, base: 4, pattern: "OX.XXXO", index: 5,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9)]] },
                Case { row: 5, base: 4, pattern: "OX.XXXO", index: 6,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9)]] },
                // OXX.XXO -> XX.XX
                Case { row: 5, base: 4, pattern: "OXX.XXO", index: 0,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9)]] },
    ...
    fn open_four() {
        run_cases(
            ...
            vec![
                // O.XXXX.O
                Case { row: 5, base: 4, pattern: "O.XXXX.O", index: 0,
                       before: vec![], after: vec![vec![(5, 5), (5, 6), (5, 7), (5, 8), (5, 9), (5, 10)]] },
